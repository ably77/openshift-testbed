...
#oc create secret generic regcred --from-file=.dockerconfigjson="${QUAY_USERNAME}-taxi-auth.json" --type=kubernetes.io/dockerconfigjson
oc create -f secrets/
...
echo https://github.com/bigkevmcd/taxi

echo
echo Clone your forked repo so you can push to it
echo git clone https://github.com/${GITHUB_USERNAME}/taxi
